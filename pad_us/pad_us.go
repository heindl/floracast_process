...
type ProtectedArea struct {
	...
	DesignationType     string `json:"Des_Tp"`
	...
	IUCNCategory   string `json:"IUCN_Cat"`
	...
	ManagerName  string `json:"Mang_Name"`
	...
	ManagerType  string `json:"Mang_Type"`
	...
	OwnerName   string `json:"Own_Name"`
	...
	OwnerType   string `json:"Own_Type"`
